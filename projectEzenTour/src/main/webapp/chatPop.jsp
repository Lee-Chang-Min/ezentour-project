...
.chat_wrap { display:flex;
	flex-direction: column-reverse;
	overflow-y:auto;
	height:700px;
	}
.chat_wrap .header { font-size: 14px; padding: 15px 0; background: #F18C7E; color: white; text-align: center; position: fixed; top:0; left:0; width:100%;  }
 
.chat_wrap .chat { padding-bottom: 130px; }
