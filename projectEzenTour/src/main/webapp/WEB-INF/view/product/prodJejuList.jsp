...
<div id="contents" class="contents">
	<div class="contentTop">
		<h2>제주의 상품페이지</h2>
		<h3>현재 제주 상품의 총갯수는 : ${jejuCount }개</h3>
	</div>


	<div class="prodContent">
		<div class="floatclear">
		<c:forEach items="${jejuList }" var="dto" varStatus="cnt" >

			<ul class="item-list">
				<c:if test="${dto.prodImage != null }">
				<li>
					<a href="${root}product/prodView?prodNo=${dto.prodNo }">
						<img width="200" height="200" src="../product/upload/${dto.prodImage.split(',')[0] }" />
					</a>
				</li>
				</c:if>
...
<!-- 페이징 -->
<%@ include file="../include/pageSeoulList.jsp" %>
<!-- 페이징 끝 -->
