...
<input type="hidden" name="memId" value="${lists[0].memId }"  readonly="readonly"/>
	<table border = 1 align="center">
		...
		<tr><td>우편번호</td>
			<td><input type="text" name="memAddrPost" 
			id="sample4_postcode" value="${lists[0].memAddrPost }"></td></tr>
		<tr><td>주소</td>
			<td><input type="text" name="memAddr" 
				id="sample4_roadAddress" 
				value="${lists.get(0).memAddr }" size="30">
				<a href="javascript:sample4_execDaumPostcode();">주소 검색</a>
			</td></tr>
		<tr><td>상세주소</td>
			<td><input type="text" name="memAddrDetail" 
				value="${lists[0].memAddrDetail }"></td></tr>
		<tr><td>연락처</td>
			<td><input type="text" name="memPh"
			value="${lists.get(0).memPh }"></td></tr>
		<tr><td>이메일</td>
		...
		<tr><td>이메일 수신여부</td>
			<td><input type="radio" name="memEmailAd" value="Y"
				 	<c:if test="${lists[0].memEmailAd == 'Y'}">checked</c:if> 
				 >예			
				<input type="radio" name="memEmailAd" value="N" 
					<c:if test="${lists[0].memEmailAd == 'N'}">checked</c:if> 
				>아니오</td></tr>
