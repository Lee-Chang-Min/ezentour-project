	...
	<div class="w3-center">
		...
		<div class="w3-bar w3-border w3-round">
			...
			<c:if test="${pageDTO.prevPage >= 1 }">
				<a href="${root }product/themeHistory?prodTheme=history&page=${pageDTO.prevPage}"
			...
			<c:forEach var="idx" begin="${pageDTO.min }" end="${pageDTO.max }">
				<c:if test="${idx == pageDTO.currentPage }">
					<a href="${root }product/themeHistory?prodTheme=history&page=${idx}"
			...
			<c:if test="${pageDTO.max < pageDTO.pageCnt }">
				<a href="${root }product/themeHistory?prodTheme=history&page=${pageDTO.nextPage}"
