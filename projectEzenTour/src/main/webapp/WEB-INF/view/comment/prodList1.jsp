...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<c:if test="${MemberCommand != null && MemberCommand.grade==0 }">
						<li class="nav-item"><a class="nav-link"
							href="/user/userView?userID=${userForm.userID}">내정보</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/cart/cartBbs?cartNum=1">장바구니</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/order/orderBbs?orderNum=1">주문조회</a></li>
						<li class="nav-item"><a class="nav-link" href="/user/Logout">로그아웃</a>
						</li>
					</c:if>
					<c:if test="${MemberCommand != null && MemberCommand.grade==1 }">
						<li class="nav-item"><a class="nav-link"
							href="/user/userList?userNum=1">회원 관리</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/order/userOrder?userOrderNum=1">주문 관리</a></li>
						<li class="nav-item"><a class="nav-link" href="/bbs/bbsWrite">제품
								등록</a></li>
						<li class="nav-item"><a class="nav-link" href="/user/Logout">로그아웃</a>
						</li>
					</c:if>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<br>
				<h1 class="my-4">
					<img class="d-block img-fluid" width="300" height="100"
						src="${pageContext.request.contextPath}/resources/img/로고.JPG">
				</h1>
				<br>
				<div class="menu">
					<ul class="accordion">
						...
						<li><a href="#menu2">목걸이</a>
							<ul>
								...
								<li><a href="/bbs/bbs?category=2&subCategory=3&num=1">패션
										목걸이</a></li>
							</ul></li>
						...
						<li><a href="#menu4">팔찌</a>
							<ul>
								...
								<li><a href="/bbs/bbs?category=4&subCategory=2&num=1">가죽
										팔찌</a></li>
								<li><a href="/bbs/bbs?category=4&subCategory=3&num=1">원석
										팔찌</a></li>
								<li><a href="/bbs/bbs?category=4&subCategory=4&num=1">은
										팔찌</a></li>
							</ul></li>
					</ul>
				</div>
			...
			<div class="col-lg-9">
				...
				<div id="carouselExampleIndicators">
						...
						<ul class="nav-container">
							<c:if test="${comCategory==1}">
								<li class="nav-item"><a class="nav-link active"
									href="/bbs/bbsView?bbsID=${bbsID}&comCategory=1&commentNum=1">후기</a></li>
								<li class="nav-item"><a class="nav-link"
									href="/bbs/bbsView?bbsID=${bbsID}&comCategory=2&commentNum=1">Q&A</a></li>
							</c:if>
					...
					<div id=tcomment>
						<input type="hidden" id="userID" name="userID"
							value="${userForm.userID}" /> <input type="hidden" id="isManager"
							name="isManager" value="${userForm.isManager}" />
						<!-- 관리자여부 -->
					</div>
					<!-- 페이징 -->
						...
						<form id="commentForm" name="commentForm"
							...
							<table class="table table-striped"
								...
								<tr>
									...
									<br>${userForm.userID}</td>
									<td><textarea id="content" name="content" cols="70"
											rows="5" maxlength="2048" class="tbox" /></textarea></td>
									<td style="text-align: center;"><br>
									<br> <c:if test="${comCategory==1}">
											<button type="button" class="btn btn-primary"
												onclick="javascript:UserReview();">작성</button>
										</c:if> <c:if test="${comCategory==2}">
											<button type="button" class="btn btn-primary"
	...
	<footer class="py-5 bg-dark">
		<div class="container">
			<p class="m-0 text-center text-white">Copyright &copy; 악세사리 쇼핑몰
				2020</p>
		</div>
		<!-- /.container -->
	</footer>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/bbsView.js"></script>
</body>
